...
*/
    ...
    async function loadProfile() {
      ...
      try {
        ...
        if (mounted && data) {
          ...
          setSkiOrBoard(data.class_period ?? "");
        }
      } catch (err) {
  ...
  function validate(): boolean {
    ...
    const validPeriods = ["Ski", "Snowboard"];
    if (!validPeriods.includes(skiOrBoard.trim())) {
  ...
  async function saveProfile() {
    ...
    try {
      ...
      const payload = {
        ...
        ski_or_board: skiOrBoard?.trim() || null,
  ...
  return (
    <View style={defaultStyles.pageContainer}>
      <View style={styles.form}>
        ...
        />
        <TextField
          placeholder="Ski or Snowboard?"
          value={skiOrBoard}
          onChangeText={setSkiOrBoard}
        />
